      ...
      <AboutInfoContainer>
        ...
        <div>
          ...
          <AboutText>
            ...
            where this company do not locate. <br />
            <br /> For 10 years we have been successfully supplying such
            countries as Ukraine, Russia, Slovenia, Serbia and many more. Our
            network consists of 20 internationally spread stores. We do as well
            offer online shopping and client support via our web-site. Anyways,
            less words, go and enjoy endless furniture items!
            <br />
            <br />
            <span>
